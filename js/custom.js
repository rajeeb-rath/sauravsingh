...
$(function() {
  ...
  $("#contact-form").submit(function(event) {
    ...
    var mailtoLink = `mailto:rajeebrath00@gmail.com?subject=${encodeURIComponent(name)} - ${encodeURIComponent(company)}&body=Phone number : ${encodeURIComponent(phone)}%0A%0A${encodeURIComponent(message)}`;
